...
async function main() {
  ...
  // Aca van los parametros si mi contructor recibe parametros,
  // y tambien van los datos de las transferencia si el contrato tiene payable.
  // Ejemplo con parametros y lo de payable:
  //   const deployedContract2 = await contractFactory.deploy(
  //     parametro1,
  //     parametro2,
  //     { gasLimit: 50000, value: 10 }
  //   );
